...
namespace Hymma.SolidTools.Addins
{
    ...
    public class AddinCommandGroup : AddinCommandGroupBase
    {
        ...
        /// <param name="commands"> a list of <see cref="AddinCommandBase"/> this group presents</param>
        ...
        public AddinCommandGroup(int userId, AddinCommandBase[] commands, string title, string description, string tooltip, string hint, Bitmap icon, bool hasToolbar = true, bool hasMenue = true )
        {
