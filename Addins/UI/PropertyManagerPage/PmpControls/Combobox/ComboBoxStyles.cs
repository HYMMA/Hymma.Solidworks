namespace Hymma.Solidworks.Addins
{
    ...
    public enum ComboBoxStyles
    {
        ...
        /// <summary>
        /// The item the user selects in the attached drop-down list does not appear in the combo box. Instead, the user's selection causes the add-in to get a callback via <see cref="PmpComboBox.PmpComboBoxSelectionChangedEventHandler"/>
        /// </summary>
